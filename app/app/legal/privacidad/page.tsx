export const metadata = {
  ...
  description: "Política de privacidad de DUX Toledo.",
};

export default function PoliticaPrivacidadPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-background/70 px-6 py-12">
...
{`María Elena Felpeto Santero

  POLÍTICA DE PRIVACIDAD

Protección de datos de carácter personal según el RGPD

María Elena Felpeto Santero, en aplicación de la normativa vigente en materia de protección de datos de carácter
personal, informa que los datos personales que se recogen a través de los formularios del Sitio web:
https://duxtoledo.com/, se incluyen en los ficheros automatizados específicos de usuarios de los servicios de María
Elena Felpeto Santero
...
María Elena Felpeto Santero adopta las medidas necesarias para garantizar la seguridad, integridad y confidencialidad
de los datos conforme a lo dispuesto en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de
...
usuario a través de email a: casarural@duxtoledo.com o en la dirección: Calle Cerro Tarra, 28, C.P. 45593 - Bargas
(Toledo).

El usuario manifiesta que todos los datos facilitados por él son ciertos y correctos, y se compromete a mantenerlos
actualizados, comunicando los cambios a María Elena Felpeto Santero

Finalidad del tratamiento de los datos personales:

¿Con qué finalidad trataremos tus datos personales?

En María Elena Felpeto Santero, trataremos tus datos personales recabados a través del Sitio Web:
https://duxtoledo.com/, con las siguientes finalidades:

1. Prestar los servicios contratados por el usuario.

2. Enviar información promocional vía electrónica.
...
1. La solicitud de información y/o la contratación de los servicios de María Elena Felpeto Santero, cuyos
...
Los datos no se comunicarán a ningún tercero ajeno a María Elena Felpeto Santero, salvo obligación legal.
...
compartido, María Elena Felpeto Santero no se hace responsable del incumplimiento por parte del usuario del RGPD.

Derechos propiedad intelectual https://duxtoledo.com/

María Elena Felpeto Santero es titular de todos los derechos de autor, propiedad intelectual, industrial, "know how" y
cuantos otros derechos guardan relación con los contenidos del sitio web https://duxtoledo.com/ y los servicios
...
sitio web https://duxtoledo.com/ sin el consentimiento previo y por escrito.

Propiedad intelectual del software

El usuario debe respetar los programas de terceros puestos a su disposición por María Elena Felpeto Santero, aún
siendo gratuitos y/o de disposición pública.

María Elena Felpeto Santero dispone de los derechos de explotación y propiedad intelectual necesarios del software.
...
de María Elena Felpeto Santero, quedando prohibido al usuario acceder, modificar, visualizar la configuración,
estructura y ficheros de los servidores propiedad de María Elena Felpeto Santero, asumiendo la responsabilidad civil y
...
Se prohíbe el uso contrario a la legislación sobre propiedad intelectual de los servicios prestados por María Elena
Felpeto Santero y, en particular de:

•  La utilización que resulte contraria a las leyes españolas o que infrinja los derechos de terceros.

•  La publicación o la transmisión de cualquier contenido que, a juicio de María Elena Felpeto Santero,
...
El usuario indemnizará a María Elena Felpeto Santero por los gastos que generara la imputación de María Elena
Felpeto Santero en alguna causa cuya responsabilidad fuera atribuible al usuario, incluidos honorarios y gastos de
defensa jurídica, incluso en el caso de una decisión judicial no definitiva.

Protección de la información alojada

María Elena Felpeto Santero realiza copias de seguridad de los contenidos alojados en sus servidores, sin embargo no
se responsabiliza de la pérdida o el borrado accidental de los datos por parte de los usuarios. De igual manera, no
...
conservados en las copias de seguridad realizadas por María Elena Felpeto Santero, cuando esta pérdida sea
...
a causas atribuibles a María Elena Felpeto Santero.

Comunicaciones comerciales

En aplicación de la LSSI. María Elena Felpeto Santero no enviará comunicaciones publicitarias o promocionales por
correo electrónico u otro medio de comunicación electrónica equivalente que previamente no hubieran sido solicitadas o
expresamente autorizadas por los destinatarios de las mismas.

En el caso de usuarios con los que exista una relación contractual previa, María Elena Felpeto Santero sí está
autorizado al envío de comunicaciones comerciales referentes a productos o servicios de María Elena Felpeto Santero
