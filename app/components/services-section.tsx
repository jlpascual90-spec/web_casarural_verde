          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Casa Rural Dux Toledo está inscrita en el Registro de Empresas y Establecimientos Turísticos de Castilla-La Mancha con número de registro <strong>45012120399</strong> y categoría de <strong>4 Estrellas Verdes</strong>, que certifica la excelencia de nuestras instalaciones y servicios como casa rural.
              </p>
            </div>
          </div>
        </div>
